...
mod tests {
    ...
    async fn test_jsonl_parsing() {
        ...
        file.write_all(br#"{"session_id":"test1","timestamp":"2024-01-01T00:00:00Z","model":"claude-3-opus","input_tokens":100,"output_tokens":50,"cache_creation_tokens":10,"cache_read_tokens":5}"#).await.unwrap();
        file.write_all(b"\n").await.unwrap();
